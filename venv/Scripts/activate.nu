...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\PycharmProjects\yandex_api_stand_tests1\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\yandex_api_stand_tests1\venv\Scripts\deactivate.nu'
